...
const Content31 = ({ className = "", iconEnvelope, heading, text, link }) => {
  return (
    <div
      className={`self-stretch flex flex-col items-start justify-start gap-4 text-left text-base text-color-scheme-1-text font-text-regular-link ${className}`}
    >
      <img
